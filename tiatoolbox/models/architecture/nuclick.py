...
class NuClick(ModelABC):
    ...
    def __init__(self, num_input_channels, num_output_channels):
        ...
        self.conv_block_1 = nn.Sequential(
            Conv_Bn_Relu(
                num_input_channels=self.n_channels, num_output_channels=64, kernelSize=7
            ),
        ...
        self.residual_block_2 = Residual_Conv(
            num_input_channels=64, num_output_channels=128
        )

        self.residual_block_3 = Residual_Conv(
        ...
        self.residual_block_8 = Residual_Conv(
            num_input_channels=512, num_output_channels=256
        )

        self.residual_block_9 = Residual_Conv(
        ...
        self.residual_block_11 = Residual_Conv(
            num_input_channels=128, num_output_channels=64
        )

        self.residual_block_12 = Residual_Conv(
